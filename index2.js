...
// import { Menu as Menu, Item as Item} from '/menu.js'
...
(async () => {
    ...
    for (const item of items) {
        ...
        summativeMenuArr.push(Menujs.Menu.createMenuForToday(menuArr));
    }
    console.log(summativeMenuArr);
